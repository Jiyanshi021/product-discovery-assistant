...
* [ ] Add project diagram in README

---

## **FAQ**

### **Q: Is ScraperAPI required?**

Yes — scraper breaks without it.

### **Q: Do I need Neo4j to run search?**

No — KG is optional. If disabled, semantic search still works.

### **Q: How many products can it handle?**

Qdrant scales to millions; current implementation handles ~5k easily.
